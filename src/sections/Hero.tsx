  ...
  return (
    <section className="flex flex-col md:flex-row justify-between items-center md:items-start mx-auto px-4 pt-24 md:pt-48 sm:px-6 lg:px-20 bg-gray-100">
      <div className="md:pr-8 md:w-1/2">
        ...
        <button
          role="button"
          className="mx-auto md:mx-0 block px-6 py-2 md:py-4 rounded-md font-bold text-xl md:text-2xl text-white bg-primary-600 hover:bg-secondary-700 transition-all duration-500 transform md:hover:scale-105"
        >
          Create a room
        </button>
      </div>
